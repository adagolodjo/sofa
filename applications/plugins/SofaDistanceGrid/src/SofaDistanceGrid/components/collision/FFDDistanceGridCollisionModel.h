...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_FFDDISTANCEGRIDCOLLISIONMODEL_H
#define SOFA_COMPONENT_COLLISION_FFDDISTANCEGRIDCOLLISIONMODEL_H
...
class SOFA_SOFADISTANCEGRID_API FFDDistanceGridCollisionModel;

class SOFA_SOFADISTANCEGRID_API FFDDistanceGridCollisionModelElement : public core::TCollisionElementIterator<FFDDistanceGridCollisionModel>
{
public:

    FFDDistanceGridCollisionModelElement(FFDDistanceGridCollisionModel* model, Index index);

    explicit FFDDistanceGridCollisionModelElement(const core::CollisionElementIterator& i);
...
{
public:
    SOFA_CLASS2(FFDDistanceGridCollisionModel, sofa::core::CollisionModel, SOFA_TEMPLATE(SingleStateAccessor, defaulttype::Rigid3Types));
...
public:
    ...
    typedef FFDDistanceGridCollisionModelElement Element;
...
inline FFDDistanceGridCollisionModelElement::FFDDistanceGridCollisionModelElement(FFDDistanceGridCollisionModel* model, Index index)
    : core::TCollisionElementIterator<FFDDistanceGridCollisionModel>(model, index)
{}

inline FFDDistanceGridCollisionModelElement::FFDDistanceGridCollisionModelElement(const core::CollisionElementIterator& i)
...
inline std::shared_ptr<DistanceGrid> FFDDistanceGridCollisionModelElement::getGrid() { return model->getGrid(index); }

inline bool FFDDistanceGridCollisionModelElement::isTransformed() { return model->isTransformed(index); }
inline const type::Matrix3& FFDDistanceGridCollisionModelElement::getRotation() { return model->getRotation(index); }
inline const type::Vec3& FFDDistanceGridCollisionModelElement::getTranslation() { return model->getTranslation(index); }
inline bool FFDDistanceGridCollisionModelElement::isFlipped() { return model->isFlipped(); }

inline std::shared_ptr<DistanceGrid> FFDDistanceGridCollisionModelElement::getPrevGrid() { return model->getPrevGrid(index); }
inline const type::Matrix3& FFDDistanceGridCollisionModelElement::getPrevRotation() { return model->getPrevRotation(index); }
inline const type::Vec3& FFDDistanceGridCollisionModelElement::getPrevTranslation() { return model->getPrevTranslation(index); }
inline double FFDDistanceGridCollisionModelElement::getPrevDt() { return model->getPrevDt(index); }

inline void FFDDistanceGridCollisionModelElement::setNewState(double dt, const std::shared_ptr<DistanceGrid> grid, const type::Matrix3& rotation, const type::Vec3& translation)
{
